...
function HomePageSlider({ dataSlider }) {
  ...
  return (
    <>
      <div className="rounded-[20px] bg-[#F1FBEB00] bg-[linear-gradient(280deg,_rgba(241,_251,_235,_1)_0%,_rgba(186,_208,_172,_1)_30%,_rgba(174,_198,_158,_1)_70%)] mb-[8rem]">
        {dataSlider &&
          dataSlider?.slice(0, 1)?.map((item) => {
            return (
